...
public class ChatSingleActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, boolean videoEnable, String roomId) {
        startType = 1;
    ...
    private void initVar() {
        ...
        if (startType == 1) {// 邀请加入时
            ...
            manager.sendMediaType(videoEnable ? MediaType.TYPE_VIDEO : MediaType.TYPE_AUDIO);
            manager.sendVideoEnable(videoEnable);
        }
